...
public class GoldenEnderswordItem extends SwordItem {
	public GoldenEnderswordItem() {
		super(new Tier() {
			public int getUses() {
				return 32;
			}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		GoldenEnderBladeRightClickProcedure.execute(com.google.common.collect.ImmutableMap.<String, Object>builder().put("x", entity.getX())
