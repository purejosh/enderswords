...
public class StoneEnderswordItem extends SwordItem {
	public StoneEnderswordItem() {
		super(new Tier() {
			public int getUses() {
				return 131;
			}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		StoneEnderBladeRightClickProcedure.execute(com.google.common.collect.ImmutableMap.<String, Object>builder().put("x", entity.getX())
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A78Durability cost: \u00A731"));
		list.add(Component.literal("\u00A78Cooldown: \u00A7a1.5s"));
	}
}
