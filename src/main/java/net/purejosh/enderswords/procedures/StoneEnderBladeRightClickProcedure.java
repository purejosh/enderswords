...
public class StoneEnderBladeRightClickProcedure {

	public static void execute(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				EnderswordsMod.LOGGER.warn("Failed to load dependency world for procedure StoneEnderBladeRightClick!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				EnderswordsMod.LOGGER.warn("Failed to load dependency x for procedure StoneEnderBladeRightClick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				EnderswordsMod.LOGGER.warn("Failed to load dependency y for procedure StoneEnderBladeRightClick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				EnderswordsMod.LOGGER.warn("Failed to load dependency z for procedure StoneEnderBladeRightClick!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				EnderswordsMod.LOGGER.warn("Failed to load dependency entity for procedure StoneEnderBladeRightClick!");
			return;
		}
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)
				.getItem() == EnderswordsModItems.STONE_ENDERSWORD) {
